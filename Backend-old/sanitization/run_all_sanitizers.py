...
def main():
    ...
    output_files = [
        'Backend-old/cleaned_datasets/k2_cleaned.csv',
        'Backend-old/cleaned_datasets/koi_cleaned.csv',
        'Backend-old/cleaned_datasets/toi_cleaned.csv'
    ]
    ...
    if os.path.exists('Backend/plots'):
        ...
        logging.info(f"  ✓ Backend-old/plots/ directory ({len(plot_files)} files)")
    else:
        logging.info(f"  ✗ Backend-old/plots/ directory (not found)")
